...
AI 资讯聚合网站，自动收录来源并展示原文标题、简介和链接。当前版本为 v0.1.3。

## 在线演示

[AI Radar](http://39.106.48.91:1010/)
...
```bash
curl -fL https://github.com/XVSHIFU/AI-Radar/releases/download/v0.1.3/ai-radar-deploy.zip -o ai-radar-deploy.zip
