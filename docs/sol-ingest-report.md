...
- Root integration expanded the frozen synthetic QueryPlanner HTTP checker to 30 cases; all passed with an injected clock and no model or PostgreSQL. See docs/query-plan-regression-results.json.
